...
/*
  ...
  Luego, no se puede olvidar liberar toda la memoria asignada dinámicamente. Por ejemplo, se puede 
  hacer al final de main.
*/

// Tipo estructura que almacena un jugador.
...
/*
  ...
  - numero_jugadores  Puntero al número de jugadores.
